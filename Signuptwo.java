    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t2.equals("")){
                ...
                Conn c = new Conn();      
				String q1 = "insert into signuptwo values('"+formno+"','"+religion+"','"+category+"','"+income+"','"+educational+"','"+occupation+"','"+pan+"','"+aadhar+"','"+seniorcitizen+"','"+existingacc+"')";
